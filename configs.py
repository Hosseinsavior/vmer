...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN" ,"5779972155:AAHZdXIgjauYS_lbTIVGZO6XmbGiWPTgiQ8")
    ...
    MONGODB_URI = os.environ.get("MONGODB_URI" ,"mongodb+srv://khodabamas30:gOAZL8dN0OJnkUfA@cluster0.phhhva5.mongodb.net/?retryWrites=true&w=majority")
